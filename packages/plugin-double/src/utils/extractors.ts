...
export async function extractProjectData(
    ...
    elizaLogger.info(
        "[🔄 DOUBLE] Extractors - Starting project data extraction"
    );
    ...
    try {
        ...
        const projectSchema = z.object({
            ...
            repositoryUrl: z
                ...
                .includes("github.com", "Must be a GitHub repository"),
...
Provide the information in a structured format.`;
        ...
        elizaLogger.info(
            "[🤖 DOUBLE] Extractors - Generating object with schema"
        );
        ...
        elizaLogger.info(
            "[📊 DOUBLE] Extractors - Generated raw project data:",
            rawProjectData
        );
        ...
        elizaLogger.info(
            "[✅ DOUBLE] Extractors - Parsed project data:",
            projectData
        );
        ...
        elizaLogger.info(
            "[✅ DOUBLE] Extractors - Validation and transformation complete:",
            transformedData
        );
        ...
        elizaLogger.error(
            "[❌ DOUBLE] Extractors - Failed to extract project data:",
            error
        );
...
function validateAndTransformProjectData(
...
export async function extractGithubUrl(
    text: string,
    runtime: IAgentRuntime
): Promise<string> {
    ...
    if (urlMatch) {
        elizaLogger.info(
            "[✅ DOUBLE] Extractors - Found GitHub URL:",
            urlMatch[0]
        );
        return urlMatch[0];
    }
